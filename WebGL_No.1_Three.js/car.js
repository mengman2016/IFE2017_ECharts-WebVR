...
//car
var material = new THREE.MeshLambertMaterial({color:0xa0a0a0});         //车身车轮材质
var carBody = new THREE.Mesh(new THREE.CubeGeometry(72,30,36),material);
scene.add(carBody);
var carWheel = [];
for (var i =0; i<4;i++){
    carWheel[i] = new THREE.Mesh(new THREE.TorusGeometry(8,2.5,60,60),material);    //4个车轮
...
//light
var ambientLight = new THREE.AmbientLight(0xeeeeee);            //环境光
var directionalLight = new THREE.DirectionalLight(0xffffff, 0.6);   //平行光
